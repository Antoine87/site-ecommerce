        ...
        INTO v_facturation;
			...
			CASE v_facturation
				...
				WHEN v_facturation IS NOT NULL THEN 
					...
					UPDATE adresses SET est_adresse_facturation = '0' WHERE id_adresse = v_facturation;
...
CASE v_context
	...
	WHEN v_context = 2 THEN SET p_message = "cette adresse existe deja";
	WHEN v_context = 3 THEN SET p_message = "Nouvelle adresse";
